...
const main = async ({
  ...
  console.log(
    `19 - Deploying wEETH Call Theta Vault With Swap on ${network.name}`
  );
  ...
  console.log(
    `RibbonThetaVaultWEETHCall strikeSelection @ ${strikeSelection.address}`
  );
  ...
  const initArgs = [
    {
      ...
      _tokenName: "Ribbon weETH Theta Vault",
      _tokenSymbol: "rweETH-THETA",
  ...
  const proxy = await deploy("RibbonThetaVaultWEETHCallWithSwap", {
  ...
  console.log(`RibbonThetaVaultWEETHCallWithSwap @ ${proxy.address}`);
...
main.tags = ["RibbonThetaVaultWEETHCallWithSwap"];
